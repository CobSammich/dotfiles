...
if [[ $1 == 1 ]]; then
    # single monitor
    xrandr --output DP-2 --primary --output HDMI-0 --off --output HDMI-1 --off
    ...
    # 3 monitors
    xrandr --output HDMI-0 --mode 1920x1080 --rate 60 --rotate left --auto --pos 0x0 --output HDMI-1 --auto --pos 3640x600 --output DP-2 --pos 1080x240 --primary
    feh --no-fehbg --bg-scale '/home/cob/Pictures/wallpapers/dmaztb4adsp61.png' '/home/cob/Pictures/wallpapers/vertical/purple_gradient.jpg' '/home/cob/Pictures/wallpapers/everblush_ign_astronaut.png'
else
